...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ConductorChanged: 'conductor.md',
  ConductorRef: 'conductor.md',
  ConductorView: 'conductor.md',
  ConductorSnapshot: 'conductor.md',
  ConductorId: 'conductor.md',
  TaskId: 'conductor.md',
  TaskSnapshot: 'conductor.md',
  TaskBlockReason: 'conductor.md',
  ConductorBlockReason: 'conductor.md',
  ConductorError: 'conductor.md',
  ConductorMode: 'conductor.md',
  ConductorPhase: 'conductor.md',
  ConductorProjection: 'conductor.md',
  TaskReportEntry: 'conductor.md',
  TaskReportStatus: 'conductor.md',
  TaskStatus: 'conductor.md',
  ConductorToolExecution: 'conductor.md',
  InitConductorRequest: 'conductor.md',
  EditConductorRequest: 'conductor.md',
  CreateTaskRequest: 'conductor.md',
  EditTaskRequest: 'conductor.md',
  TaskReportRequest: 'conductor.md',
  SpawnedWorker: 'conductor.md',
  HandoverResult: 'conductor.md',
  DeliverResult: 'conductor.md',
  ReportResult: 'conductor.md',
